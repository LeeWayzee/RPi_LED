...
# classify the digital pipe
class CADT_PIPE():
    """
    defalt setting chose BCM to decode
    plus,the defalut pin for a-b-c-d-e-f-g
    ...
    def draw_number(self,num):
        if num == 0:
            GPIO.output(self.pin_vcc, GPIO.HIGH)
            GPIO.output(self.pin_a, GPIO.LOW)
